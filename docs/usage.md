...
| `sample_group`   | Identifier for grouping multiple experimental samples (experimentalIDs) into the same biological conditions.                                                                           |
